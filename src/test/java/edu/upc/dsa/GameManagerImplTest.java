...
public class GameManagerImplTest {
    ...
    public void setUp() {
        ...
        user = new User("123", "Ivan", "Requena");
        //Appending data to Object List
        listGameObjects.add(new Objeto("1", "Martillo"));
        listGameObjects.add(new Objeto("2", "Espada"));
        listGameObjects.add(new Objeto("3", "Satisfyer"));
